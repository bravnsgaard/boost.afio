...
struct path::make_absolute : public path
{
  ...
  make_absolute(T &&p)
      : path(std::move(filesystem::absolute(std::forward<T>(p))))
  {
  }
};
...
#   ifndef DOXYGEN_SHOULD_SKIP_THIS
  uint16_t st_perms;
#   else  /*_ !defined(DOXYGEN_SHOULD_SKIP_THIS) _*/
...
#  else  /*_ 0 // used to find where std::move() isn't being used, and should be _*/
  async_io_op(const async_io_op &o)
      : parent(o.parent)
      , id(o.id)
      , h(o.h)
...
#  endif  /*_ 0 // used to find where std::move() isn't being used, and should be _*/
  //! \mconstr
...
#   endif  /*_ defined(BOOST_AFIO_ENABLE_BENCHMARKING_COMPLETION) || BOOST_AFIO_HEADERS_ONLY == 0 // Only really used for benchmarking _*/
#  endif  /*_ !defined(DOXYGEN_SHOULD_SKIP_THIS) _*/
...
#  endif  /*_ defined(BOOST_AFIO_ENABLE_BENCHMARKING_COMPLETION) // Only really used for benchmarking _*/
...
#    define BOOST_AFIO_SECDEC_INTRINSICS 1
#   endif  /*_ defined(_MSC_VER) && (defined(_M_X64) || _M_IX86_FP == 1) _*/
#  endif  /*_ !defined(BOOST_AFIO_SECDEC_INTRINSICS) _*/
#  ifndef BOOST_AFIO_SECDEC_INTRINSICS
...
#  else  /*_ BOOST_AFIO_SECDEC_INTRINSICS && 0 // let constexpr do its thing _*/
        for(size_t p = 0; ecc_twospowers[p] < (b + 1); p++)
          b++;
#  endif  /*_ BOOST_AFIO_SECDEC_INTRINSICS && 0 // let constexpr do its thing _*/
...
#  endif  /*_ !defined(BOOST_AFIO_DISABLE_STD_HASH_SPECIALIZATION) _*/
...
#  endif  /*_ BOOST_AFIO_HEADERS_ONLY == 1 && !defined(DOXYGEN_SHOULD_SKIP_THIS) _*/

# endif  /*_ defined(BOOST_AFIO_NEED_DEFINE) _*/
#endif  /*_ !defined(BOOST_AFIO_HEADER_INCLUDED) _*/
