...
#endif  /*_ !defined(BOOST_AFIO_MAX_NON_ASYNC_QUEUE_DEPTH) _*/
...
#endif  /*_ !defined(BOOST_AFIO_NEVER_VALIDATE_INPUTS) && !defined(BOOST_AFIO_COMPILING_FOR_GCOV) _*/
...
# endif  /*_ !defined(NDEBUG) || defined(BOOST_AFIO_RUNNING_IN_CI) _*/
#endif  /*_ !defined(BOOST_AFIO_OP_STACKBACKTRACEDEPTH) _*/
...
#endif  /*_ && !defined(__FreeBSD__) && !defined(WIN32)) || defined(BOOST_AFIO_COMPILING_FOR_GCOV) _*/
...
# endif  /*_ !defined(BOOST_AFIO_DEBUG_PRINTING) _*/
# ifdef WIN32
...
#else  /*_ && BOOST_AFIO_DEBUG_PRINTING) _*/
# define BOOST_AFIO_DEBUG_PRINT(...)
#endif  /*_ && BOOST_AFIO_DEBUG_PRINTING) _*/

#ifndef _GNU_SOURCE
# define _GNU_SOURCE
#endif  /*_ !defined(_GNU_SOURCE) _*/
...
#else  /*_ defined(BOOST_AFIO_USE_CONCURRENT_UNORDERED_MAP) _*/
BOOST_AFIO_V1_NAMESPACE_BEGIN
...
BOOST_AFIO_V1_NAMESPACE_END
#endif  /*_ defined(BOOST_AFIO_USE_CONCURRENT_UNORDERED_MAP) _*/
...
# endif  /*_ !defined(S_IFSOCK) _*/
# ifndef S_IFBLK
#  define S_IFBLK 0x6000
# endif  /*_ !defined(S_IFBLK) _*/
# ifndef S_IFIFO
#  define S_IFIFO 0x1000
# endif  /*_ !defined(S_IFIFO) _*/
# ifndef S_IFLNK
#  define S_IFLNK 0xA000
# endif  /*_ !defined(S_IFLNK) _*/
#endif  /*_ defined(WIN32) _*/
BOOST_AFIO_V1_NAMESPACE_BEGIN
...
#else  /*_ defined(AT_FDCWD) _*/
static BOOST_CONSTEXPR_OR_CONST int at_fdcwd = -100;
#endif  /*_ defined(AT_FDCWD) _*/
...
# endif  /*_ defined(HAVE_STAT_FLAGS) _*/
# ifdef HAVE_STAT_GEN
  if(!!(wanted & metadata_flags::gen))
  {
    stat.st_gen = s.st_gen;
  }
# endif  /*_ defined(HAVE_STAT_GEN) _*/
...
#  else  /*_ defined(__APPLE__) _*/
  if(!!(wanted & metadata_flags::birthtim))
  {
    stat.st_birthtim = to_timepoint(s.st_birthtim);
  }
#  endif  /*_ defined(__APPLE__) _*/
# endif  /*_ defined(HAVE_BIRTHTIMESPEC) _*/
...
#    include <execinfo.h>
#    include <cxxabi.h>
#   endif  /*_ defined(__linux__) || defined(__FreeBSD__) && !defined(__ANDROID__) _*/
#  endif  /*_ 0 _*/
BOOST_AFIO_V1_NAMESPACE_BEGIN
typedef std::vector<void *> stack_type;
inline void collect_stack(stack_type &stack)
...
#  else  /*_ defined(UNW_LOCAL_ONLY) _*/
  stack.resize(BOOST_AFIO_OP_STACKBACKTRACEDEPTH);
  stack.resize(backtrace(&stack.front(), stack.size()));
#  endif  /*_ defined(UNW_LOCAL_ONLY) _*/
}
...
#endif  /*_ !defined(IOV_MAX) || defined(__APPLE__) // Android lacks preadv() and pwritev() _*/
...
#endif  /*_ BOOST_AFIO_POSIX_PROVIDES_AT_PATH_FUNCTIONS || defined(WIN32) _*/
    }
...
#  endif  /*_ 0 // We don't attempt refresh semantics as none are promised on FreeBSD for files _*/
          }
          else
          {
            size_t len;
...
#endif  /*_ BOOST_AFIO_POSIX_PROVIDES_AT_PATH_FUNCTIONS _*/
        {
...
#  ifdef AT_EMPTY_PATH
          if(fd >= 0 && -1 != BOOST_AFIO_POSIX_LINKAT(fd, "", newdirh ? (int) (size_t) newdirh->native_handle() : at_fdcwd, req.path.c_str(), AT_EMPTY_PATH))
            return;
#  endif  /*_ defined(AT_EMPTY_PATH) _*/
          auto dirh(int_verifymyinode());
          if(!dirh)
          {
            errno = ENOENT;
...
# else  /*_ BOOST_AFIO_POSIX_PROVIDES_AT_PATH_FUNCTIONS _*/
...
#else  /*_ defined(BOOST_AFIO_OP_STACKBACKTRACEDEPTH) _*/
    void fillStack() {}
#endif  /*_ defined(BOOST_AFIO_OP_STACKBACKTRACEDEPTH) _*/
...
#endif  /*_ defined(BOOST_AFIO_ENABLE_BENCHMARKING_COMPLETION) || BOOST_AFIO_HEADERS_ONLY == 0 _*/
// Called in unknown thread
...
#endif  /*_ defined(O_PATH) _*/
      }
      else if(!!(req.flags & file_flags::int_opening_dir))
      {
#ifdef O_DIRECTORY
        flags |= O_DIRECTORY;
#endif  /*_ defined(O_DIRECTORY) _*/
#ifdef O_SEARCH
        flags |= O_SEARCH;
#endif  /*_ defined(O_SEARCH) _*/
...
#  endif  /*_ defined(MNT_ACLS) && defined(MNT_NFS4ACLS) _*/
...
#endif  /*_ defined(WIN32) && !defined(USE_POSIX_ON_WIN32) _*/
...
#else  /*_ defined(WIN32) && !defined(USE_POSIX_ON_WIN32) _*/
...
# ifdef MAP_HUGETLB
        flags |= MAP_HUGETLB;
# endif  /*_ defined(MAP_HUGETLB) _*/
# ifdef MAP_ALIGNED_SUPER
        flags |= MAP_ALIGNED_SUPER;
# endif  /*_ defined(MAP_ALIGNED_SUPER) _*/
# ifdef VM_FLAGS_SUPERPAGE_SIZE_ANY
        flags |= VM_FLAGS_SUPERPAGE_SIZE_ANY;
# endif  /*_ defined(VM_FLAGS_SUPERPAGE_SIZE_ANY) _*/
      }
