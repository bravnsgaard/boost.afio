...
int main(int argc, const char *argv[])
{
    ...
    writers = totalwriters = atoi(argv[1]);
  {
    ...
    auto mkdir1(
    dispatcher->dir(async_path_op_req::relative(mkdir, "1", file_flags::Create)));
    auto mkdir2(
    dispatcher->dir(async_path_op_req::relative(mkdir, "2", file_flags::Create)));
    auto mkdir3(
    dispatcher->dir(async_path_op_req::relative(mkdir, "3", file_flags::Create)));
    auto mkdir4(
    dispatcher->dir(async_path_op_req::relative(mkdir, "4", file_flags::Create)));
    auto mkdir5(
    dispatcher->dir(async_path_op_req::relative(mkdir, "5", file_flags::Create)));
    auto mkdir6(
    dispatcher->dir(async_path_op_req::relative(mkdir, "6", file_flags::Create)));
    auto mkdir7(
    dispatcher->dir(async_path_op_req::relative(mkdir, "7", file_flags::Create)));
    auto mkdir8(
    dispatcher->dir(async_path_op_req::relative(mkdir, "8", file_flags::Create)));
